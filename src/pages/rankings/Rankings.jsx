...
const Vietmap = () => {
    ...
    <div className="flex flex-col items-center">
        ...
        <img className="w-[80%] md:w-[50%] xl:w-[30%] " src={cnvietmap} alt="Vietmap" />

        
        <div className="flex flex-col gap-4 py-5 w-[80%]  md:w-[50%] xl:w-[30%]">
  {/* Gói 1 năm */}<p className="text-xl pt-5 text-center">Bảng giá gia hạn Vietmap Live Pro</p>
  <div className="flex items-center justify-between bg-blue-500 rounded-2xl px-5 py-4 text-white shadow-md">
    <div className="flex items-center gap-3">
      <img src={vietmap} alt="Vietmap" className="w-12 h-12 rounded-lg" />
   ...
   <div className="py-5">
          <button
            className="bg-gray-100 px-5 py-2 rounded-lg
             ...
             animate-zoom"
          >
            <a href="https://zalo.me/0964445201" className="font-bold text-red-500 text-lg">
              Liên hệ ngay để gia hạn : 096.444.5201
            </a>
          </button>
        </div>
</div>
